  ...
  steps = {
    {
      ...
      body = {
        ...
        "works too. Steps can also carry `input` (ask the user something),",
        "`cond` (skip when it does not apply), and enter/complete hooks.",
        "",
    ...
    },
    {
      ...
      body = {
        ...
        "        {",
        "          id = \"who\",",
        "          title = \"Say hi to {ctx:coder}\",",
        "          body = { \"Time to introduce yourself.\" },",
        "          input = { question = \"Coder name\", store = \"coder\" },",
        "          completion = {",
        "            { context = function(ctx) return ctx.coder ~= nil end },",
        "          },",
        "        },",
        "        {",
        "          id = \"bye\",",
        ...
        "    }",
        "",
        "The last step asks its user a question and speaks the answer back —",
        "{ctx:coder} reads ctx; {answer:…} reads an answer back by step id.",
    ...
    },
    {
      ...
      body = {
        ...
        "    :Tutorial my-first",
        "",
        "Finish its four steps — {key:d}, the echo, answer its question, then",
        "{key:d} once more — press {key:q} to pause it, and come back here.",
        "Your progress on both tours is saved side by side.",
      },
